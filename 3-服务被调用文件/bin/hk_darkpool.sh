#!/bin/bash
# Author: rong.xing@vipshop.com (xingrong)
binary="seek-jar-with-dependencies.jar"
main="com.vip.seek.app.robotnews.HK_ShareIPO"
logfile="HK_ShareIPO.log"
#MAVEN_OPTS="-Xms32G -Xmx32G -XX:NewRatio=1 -XX:PermSize=64M -XX:MaxPermSize=128M"
MAVEN_OPTS="-Xms8G -Xmx16G -XX:PermSize=64M -XX:MaxPermSize=128M"
